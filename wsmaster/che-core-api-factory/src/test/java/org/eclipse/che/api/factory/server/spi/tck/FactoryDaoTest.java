...
public class FactoryDaoTest {
    ...
    public void shouldGetFactoryByAttribute() throws Exception {
        ...
        final List<FactoryImpl> factories = factoryDao.getByAttribute(1, 0, ImmutableList.of(Pair.of("name", factory.getName())));
        assertEquals(factories.get(0), factory);
    }

    @Test(expectedExceptions = IllegalArgumentException.class)
    public void shouldThrowIllegalArgumentExceptionWhenSkipCountIsNegative() throws Exception {
        factoryDao.getByAttribute(1, -5, ImmutableList.of(Pair.of("name", "factory")));
    }
